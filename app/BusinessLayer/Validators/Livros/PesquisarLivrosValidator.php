...
class PesquisarLivrosValidator {
    ...
    private $regras = [
        ...
        'titulo_original' => 'nullable|min:3',
        'idioma' => 'nullable|min:3',
        'data_publicacao' => 'nullable|date',
        'sinopse' => 'nullable|min:10',
        'total_paginas' => 'nullable|numeric',
        'editora' => 'nullable|min:3',
    ...
    private $mensagens = [
        ...
        'titulo.min' => 'O campo TITULO precisa ter no mínimo 3 caracteres.',
        'titulo_original.min' => 'O campo TITULO ORIGINAL precisa ter no mínimo 3 caracteres.',
        ...
        'editora.min' => 'O campo EDITORA precisa ter no mínimo 3 caracteres.',
        'autor.min' => 'O campo AUTOR precisa ter no mínimo 3 caracteres.',
        'genero.min' => 'O campo GÊNERO precisa ter no mínimo 3 caracteres.',
        'serie.min' => 'O campo SÉRIE precisa ter no mínimo 3 caracteres.'
    ];
    ...
    public function execute(array $dados) : void {
        ...
        $this->regras['sort.*'] = [new ColunaExisteEmTabelaRule('livro')];
